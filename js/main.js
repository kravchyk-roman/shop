$(function() {
  ...
  // $('.footer-top__nav').on('click', function() {
  //   $('.footer-top__list').slideToggle();
  // });

  $('.blog-page__slider').slick({
    prevArrow: '<button type="button" class="slick-prev"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="9pt" height="14pt" viewBox="0 0 9 14" version="1.1"><g><path d="M 1.113281 6.535156 L 5.894531 2.816406 C 6.226562 2.558594 6.761719 2.558594 7.085938 2.816406 L 7.882812 3.433594 C 8.210938 3.691406 8.210938 4.105469 7.882812 4.359375 L 4.496094 7 L 7.886719 9.636719 C 8.214844 9.894531 8.214844 10.308594 7.886719 10.5625 L 7.089844 11.183594 C 6.761719 11.441406 6.226562 11.441406 5.898438 11.183594 L 1.117188 7.464844 C 0.785156 7.207031 0.785156 6.792969 1.113281 6.535156 Z M 1.113281 6.535156 "/></g></svg></button>',
    nextArrow: '<button type="button" class="slick-next"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="9pt" height="14pt" viewBox="0 0 9 14" version="1.1"><g><path d="M 7.886719 7.464844 L 3.105469 11.183594 C 2.773438 11.441406 2.238281 11.441406 1.914062 11.183594 L 1.117188 10.566406 C 0.789062 10.308594 0.789062 9.894531 1.117188 9.640625 L 4.507812 7.003906 L 1.117188 4.367188 C 0.789062 4.109375 0.789062 3.695312 1.117188 3.441406 L 1.910156 2.816406 C 2.238281 2.558594 2.773438 2.558594 3.101562 2.816406 L 7.882812 6.535156 C 8.214844 6.792969 8.214844 7.207031 7.886719 7.464844 Z M 7.886719 7.464844"/></g></svg></button>',
    infinite: false
  });
  ...
  $('.button-list').on('click', function() {
   ...
   $('.button-grid').on('click', function() {
    ...
    $('.shop-content__inner').removeClass('removeClass');
  });

  $('.secelt-style, .product-one__num').styler();
